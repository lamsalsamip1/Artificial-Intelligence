# Implementation of Greedy Best First and A start search algorithms in the Romania problem given in the book Artificial Intelligence, A modern approach
...
def Astar(startNode, heuristics, graph, goalNode="Bucharest"):
    ...
    distance = 0 #needed for A star to store distance till now
    path = []
